...
<div class="rentsale container justify-content-center d-flex align-items-center mt-5" id="rentform">
    ...
    <form action="store" method="POST" enctype="multipart/form-data" class="container js-switch__message-text create-listing-form">
        @csrf
    ...
    <div id="smartwizard1">
        ...
        <div class="mt-4">
            <div id="step-1">
                ...
                <div class="row">
                    <div class="col-md-6"> <input name="title" type="text" class="form-control" placeholder="Property Title" > </div>
                   
                    <div class="col-md-6">
                         <select name="property_type" class="form-control" id="property_type" name="property_type">
                ...
                <div class="row mt-3">
                    <div class="col-md-6"> 
                       <select name="property_status" class=" form-control"  searchable="Search here..." id="property_status">
            ...
            <div id="step-2">
                ...
                <div class="row mt-3">
                       ...
                       <div class="col-md-6">
                      <select name="rent_duration" id="rent-duration" class="form-control">
            ...
            <div id="step-3" class="">
                <div class="row">
                    ...
                    <div class="col-md-6"><input class="form-control" name="bedrooms"  id="prop_beds1" value="" placeholder="Enter number of bedrooms" type="number" min="1" max="99" >
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-6">   <input class="form-control" name="bathrooms"  id="prop_beds2" value="" placeholder="Enter number of bathrooms" type="number" min="1" max="99">
                    </div>
                    <div class="col-md-6">  <input class="form-control" name="area"  id="prop_beds3" value="" placeholder="Enter property area size sq ft" type="text" >
                    </div>
                </div>
                <div class="row mt-3">
           ...
           <div class="row mt-3">
                ...
                <div class="needsclick dropzone image-upload" id="main_photo-dropzone">
                    <div class="dplay-tbl-cell "> <i class="fa fa-cloud-upload"></i>
                        <h5><b>Choose Your Main image to Upload</b></h5>
                        <h6 class="mt-10 mb-70">Or Drop Your Main Image Here</h6>
                    </div>
                </div>
               
                <div class="needsclick dropzone image-upload" id="gallery-dropzone">
                    <div class="dplay-tbl-cell "> <i class="fa fa-cloud-upload"></i>
                        <h5><b>Choose Your Gallery to Upload</b></h5>
                        <h6 class="mt-10 mb-70">Or Drop Your Property gallery Here</h6>
                    </div>
                </div>
