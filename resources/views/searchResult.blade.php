    ...
    <div id="bannerCarousole" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item banner-max-height active">
                <img class="d-block w-100" src="assets/img/banner/banner-1.jpg" alt="banner">
            ...
            <div class="carousel-item banner-max-height">
                <img class="d-block w-100" src="assets/img/banner/banner-3.jpg" alt="banner">
                <div class="carousel-caption banner-slider-inner d-flex h-100 text-center">
                    <div class="carousel-content container">
                        <div class="text-center">
                            <div class="btn-sections">
...
{{-- property rent --}}
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 filtr-item" data-category="{{$propertyrent->id}}">
                    <div class="property-box">
                        ...
                        <div class="detail">
                            ...
                            <div class="location">
                                <a href="{{ route('rent.show',$propertyrent->id) }}" method="POST">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 filtr-item mb-5" data-category="{{$propertysale->id}}">
                    <div class="property-box">
        ...
        <div class="slick-slider-area">
            <div class="row slick-carousel" data-slick='{"slidesToShow": 4, "responsive":[{"breakpoint": 1024,"settings":{"slidesToShow": 2}}, {"breakpoint": 768,"settings":{"slidesToShow": 1}}]}'>
                <div class="slick-slide-item">
                    <div class="property-box-5">
                        <div class="property-photo">
                            <img class="img-fluid" src="assets/img/properties/properties-1.jpg" alt="properties">
                ...
                <div class="slick-slide-item">
                    <div class="property-box-5">
                        <div class="property-photo">
                            <img class="img-fluid" src="assets/img/properties/properties-2.jpg" alt="properties">
                            <div class="date-box">For Sale</div>
                        </div>
                        <div class="detail">
                            <div class="heading">
                ...
                <div class="slick-slide-item">
                    <div class="property-box-5">
                        <div class="property-photo">
                            <img class="img-fluid" src="assets/img/properties/properties-3.jpg" alt="properties">
                ...
                <div class="slick-slide-item">
                    <div class="property-box-5">
                        <div class="property-photo">
                            <img class="img-fluid" src="assets/img/properties/properties-4.jpg" alt="properties">
                            <div class="date-box">For Sale</div>
                        </div>
                        <div class="detail">
                            <div class="heading">
                ...
                <div class="slick-slide-item">
                    <div class="property-box-5">
                        <div class="property-photo">
                            <img class="img-fluid" src="assets/img/properties/properties-5.jpg" alt="properties">
                            <div class="date-box">For Sale</div>
                        </div>
                        <div class="detail">
                            <div class="heading">
